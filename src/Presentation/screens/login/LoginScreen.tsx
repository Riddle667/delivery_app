...
import { RootStackParamList } from '../../navigator/MainAppStack'
...
export const LoginScreen = ({navigation, route}: Props) => {
  ...
  const { email, password, onChange, setValues } = LoginViewModel();
        ...
        <View style={ Loginstyles.form }>
          ...
          >
            ...
            <View style= {{ marginTop: 30 }}>
              <RoundedButton text='Iniciar Sesión' onPress={ () => console.log('Login') } />
